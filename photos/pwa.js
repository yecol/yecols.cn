...
function picasaweb(j){ //returns the list of all albums for the user
 ...
 $("<div style='margin-left:3px'>Gallery Home</div><div style='text-align:right; margin-right:5px; margin-top:-14px'><a target=PICASA class='standard' href='random.asp'>View Random Photos</a></div><br>");
 ...
 // then display them in a table with 4 columns (along with the album title)
  ...
  $("<td valign=top><div class='SPRITE_shadow'><div class='gphoto-album-cover-frame'><a class='standard' href='?albumid="+id_base+"'><img src='"+img_base+"?imgmax=144&crop=1' class='pwimages' /></a></div></div>");
  $("<center><a class='standard' href='?albumid="+id_base+"'>"+ j.feed.entry[i].title.$t +"</a></center></td>");
...
if (n1 == null) //we're at the last picture in the album; going forward takes us to the album index
 ...
 if (photo_array.length > 1) { $("<td><a class='standard' href='"+prev+"'><img border=0 alt='Previous item' src='images/prev.png' title='上一张'></a> </td><td></td>"); }
 $("<td> <a class='standard' href='"+album_base_path+"'><img border=0 alt='Back to album index' src='images/returntoalbum.png' title='返回相册'></a> </td>");
 if (photo_array.length > 1) { $("<td></td><td> <a class='standard' href='"+next+"'><img border=0 alt='Next item' src='images/next.png' title='下一张'></a></td>"); }
 $("</tr></table></center><br>");
 ...
 $("<center><img id='picture' width="+display_width+" src='"+img_base+"?imgmax="+photosize+"' class='singleImage' /></center>");
