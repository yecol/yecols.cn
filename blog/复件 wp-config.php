...
define('DB_NAME', 'ddolphin');
define('WP_CACHE', true);

/** MySQL数据库用户名 */
define('DB_USER', 'ddolphin');

/** MySQL数据库密码 */
define('DB_PASSWORD', 'xjb7002095');

/** MySQL主机名 */
define('DB_HOST', '203.171.236.25');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY', '7002095');
define('SECURE_AUTH_KEY', '7002095');
define('LOGGED_IN_KEY', '7002095');
define('NONCE_KEY', '7002095');
/**#@-*/
