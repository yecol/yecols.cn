...
<style type="text/css" media="screen">
  ...
  body{ behavior:url(<?php bloginfo('template_url'); ?>/ie6hoverfix.htc); }
  img, #sidebar, #sidebar .wrap { behavior: url("<?php bloginfo('template_url'); ?>/ie6pngfix.htc")  }
</style>
<![endif]-->

<!--[if IE 7]>
<style type="text/css" media="all">@import "<?php bloginfo('template_url'); ?>/ie7.css";</style>
<![endif]-->
...
<?php if($options['sidebarpos']=='left') { ?>
<style type="text/css" media="all">@import "<?php bloginfo('template_url'); ?>/options/leftsidebar.css";</style>
<!--[if lte IE 6]>
<style type="text/css" media="all">@import "<?php bloginfo('template_url'); ?>/options/leftsidebar-ie6.css";</style>
<![endif]-->
<?php }?>
<?php // custom css?
  ...
  <div id="page-wrap1">
    <div id="page-wrap2">
      ...
      <div id="page">
        ...
        <div id="main-wrap">
          <!-- main (container) -->
          <div id="main" <?php if(!is_page_template('page-nosidebar.php')) { ?>class="with-sidebar"<?php } ?>>
            <!-- header -->
            <div id="header">
              ...
              if($options['logoimage']) {
					?><a id="logo" href="<?php bloginfo('url'); ?>/"><img src="<?php bloginfo('template_url'); ?>/logo.png" title="<?php bloginfo('name');  ?>" alt="<?php bloginfo('name');  ?>" /></a><?php
				} else {
              ...
              <div id="tabs">
               ...
               <?php
                 if($options['categorytabs']) {
                  echo preg_replace('@\<li([^>]*)>\<a([^>]*)>(.*?)\<\/a>@i', '<li$1><a$2><span><span>$3</span></span></a>', wp_list_categories('show_count=0&echo=0&exlude=181&title_li='));
                  }
                 else {
