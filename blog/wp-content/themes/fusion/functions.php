...
class FusionOptions {
	...
	function add() {
		...
		add_theme_page("Fusion Options", "Fusion Options", 'edit_themes', basename(__FILE__), array('FusionOptions', 'display'));
	}
