...
class wp_thread_comment{
	...
	function defaultoption($key=''){
		...
		if($key === 'cancel_reply'){
			...
			return __('<div class="comment-childs<?php echo $deep%2 ? \' chalt\' : \'\'; ?>" id="comment-[ID]"><cite>[author]</cite> Reply:[moderation]<br /><small class="commentmetadata">[date] at [time]</small></p>[content]</div>','wp-thread-comment');
